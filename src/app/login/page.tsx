  ...
  return (
    <div className="w-screen h-screen ">
      <div className="w-5/5 bg-gradient-to-r  h-full flex items-center justify-center z-10">
        <div className="absolute top-0 left-0  flex items-start h-full  justify-end w-full bg-cyan-500  z-10 md:clip-path-loginPoly">
          <img src="/loginbg.png" alt="" className="    object-cover mt-16" />
        </div>
        <div className="w-2/5 h-[300px]   p-8 rounded-lg z-10 bg-slate-800">
